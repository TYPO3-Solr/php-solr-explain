 ...
 */
class SummarizeLeafImpactsTestCase extends \Solr\Tests\Domain\Result\Explanation\AbstractExplanationTestCase{
	...
	public function verifyFixtureLeafImpactSum($fixtureName, $expectedImpactSum = 100) {
		...
		$visitor = new \Solr\Domain\Result\Explanation\Visitors\SummarizeLeafImpacts();
