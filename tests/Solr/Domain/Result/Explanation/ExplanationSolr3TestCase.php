 ...
 */
class ExplanationSolr3TestCase extends \Solr\Tests\Domain\Result\Explanation\AbstractExplanationTestCase{
	...
	public function testFixture001GetImpact() {
		...
		$this->assertEquals(\Solr\Domain\Result\Explanation\Nodes\Explain::NODE_TYPE_SUM,$explain->getRootNode()->getNodeType());
		$this->assertEquals(\Solr\Domain\Result\Explanation\Nodes\Explain::NODE_TYPE_SUM,$explain->getRootNode()->getChild(0)->getNodeType());
		...
		$this->assertEquals(\Solr\Domain\Result\Explanation\Nodes\Explain::NODE_TYPE_MAX,$explain->getRootNode()->getChild(0)->getChild(0)->getNodeType());
	}
